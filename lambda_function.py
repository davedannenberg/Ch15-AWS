    ...
    if age is not None:
        ...
        if age < 0:
            ...
            return build_validation_result(
                False,
                "age",
                "You are too old to plan for retirement!",
            )
        # Confirm the investment amount is greater than 5000
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "You do not have enough money to plan for retirement!",
            )
    return build_validation_result(True, None, None)
def get_investment_recommendation(risk_level):
    """
   Recommend investment startegy based on the risk appetite.
    """
    risk_levels = {
        "none": "100% bonds (AGG), 0% equities (SPY)",
        "low": "60% bonds (AGG), 40% equities (SPY)",
    ...
    #make lower case to capture all occurences
